...
#include "RPRMaterialEditorInstanceDetailCustomization.h"
...
TSharedRef<IDetailCustomization> FRPRMaterialInstanceParameterDetails::MakeInstance(UMaterialEditorInstanceConstant* MaterialInstance, FGetShowHiddenParameters InShowHiddenDelegate)
{
	return MakeShareable(new FRPRMaterialInstanceParameterDetails(MaterialInstance, InShowHiddenDelegate));
}

FRPRMaterialInstanceParameterDetails::FRPRMaterialInstanceParameterDetails(UMaterialEditorInstanceConstant* MaterialInstance, FGetShowHiddenParameters InShowHiddenDelegate)
	: MaterialEditorInstance(MaterialInstance)
	, ShowHiddenDelegate(InShowHiddenDelegate)
{
}

TOptional<float> FRPRMaterialInstanceParameterDetails::OnGetValue(TSharedRef<IPropertyHandle> PropertyHandle)
{
	float Value = 0.0f;
...
void FRPRMaterialInstanceParameterDetails::OnValueCommitted(float NewValue, ETextCommit::Type CommitType, TSharedRef<IPropertyHandle> PropertyHandle)
{
	// Try setting as float, if that fails then set as int
	ensure(PropertyHandle->SetValue(NewValue) == FPropertyAccess::Success);
}

void FRPRMaterialInstanceParameterDetails::CustomizeDetails(IDetailLayoutBuilder& DetailLayout)
{
	...
	.ValueContent()
		...
		.AllowClear(true)
		.OnShouldSetAsset(this, &FRPRMaterialInstanceParameterDetails::OnShouldSetAsset)
		];
...

	{
		...
		PropertyRow.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FRPRMaterialInstanceParameterDetails::ShouldShowMaterialRefractionSettings)));
	}

	{
		IDetailPropertyRow& PropertyRow = DefaultCategory.AddProperty("bOverrideSubsurfaceProfile");
		PropertyRow.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FRPRMaterialInstanceParameterDetails::ShouldShowSubsurfaceProfile)));
	}
...
void FRPRMaterialInstanceParameterDetails::CreateGroupsWidget(TSharedRef<IPropertyHandle> ParameterGroupsProperty, IDetailCategoryBuilder& GroupsCategory)
{
...
void FRPRMaterialInstanceParameterDetails::CreateSingleGroupWidget(FEditorParameterGroup& ParameterGroup, TSharedPtr<IPropertyHandle> ParameterGroupProperty, IDetailGroup& DetailGroup)
{
...
void FRPRMaterialInstanceParameterDetails::CreateParameterValueWidget(UDEditorParameterValue* Parameter, TSharedPtr<IPropertyHandle> ParameterProperty, IDetailGroup& DetailGroup)
{
	TSharedPtr<IPropertyHandle> ParameterValueProperty = ParameterProperty->GetChildHandle("ParameterValue");

	if (ParameterValueProperty->IsValidHandle())
	{
		TAttribute<bool> IsParamEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FRPRMaterialInstanceParameterDetails::IsOverriddenExpression, Parameter));

		IDetailPropertyRow& PropertyRow = DetailGroup.AddPropertyRow(ParameterValueProperty.ToSharedRef());

		FIsResetToDefaultVisible IsResetVisible = FIsResetToDefaultVisible::CreateSP(this, &FRPRMaterialInstanceParameterDetails::ShouldShowResetToDefault, Parameter);
		FResetToDefaultHandler ResetHandler = FResetToDefaultHandler::CreateSP(this, &FRPRMaterialInstanceParameterDetails::ResetToDefault, Parameter);
		FResetToDefaultOverride ResetOverride = FResetToDefaultOverride::Create(IsResetVisible, ResetHandler);

		PropertyRow
			.DisplayName(FText::FromName(Parameter->ParameterName))
			.ToolTip(GetParameterExpressionDescription(Parameter))
			.EditCondition(IsParamEnabled, FOnBooleanValueChanged::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OnOverrideParameter, Parameter))
			.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FRPRMaterialInstanceParameterDetails::ShouldShowExpression, Parameter)))
			// Handle reset to default manually
			.OverrideResetToDefault(ResetOverride);
	}
}

void FRPRMaterialInstanceParameterDetails::CreateMaskParameterValueWidget(UDEditorParameterValue* Parameter, TSharedPtr<IPropertyHandle> ParameterProperty, IDetailGroup& DetailGroup)
{
	TSharedPtr<IPropertyHandle> ParameterValueProperty = ParameterProperty->GetChildHandle("ParameterValue");
	...
	if (ParameterValueProperty->IsValidHandle())
	{
		...
		IDetailPropertyRow& PropertyRow = DetailGroup.AddPropertyRow(ParameterValueProperty.ToSharedRef());
		PropertyRow.EditCondition(IsParamEnabled, FOnBooleanValueChanged::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OnOverrideParameter, Parameter));
		// Handle reset to default manually
		PropertyRow.OverrideResetToDefault(FResetToDefaultOverride::Create(FResetToDefaultHandler::CreateSP(this, &FRPRMaterialInstanceParameterDetails::ResetToDefault, Parameter)));
		PropertyRow.Visibility(TAttribute<EVisibility>::Create(TAttribute<EVisibility>::FGetter::CreateSP(this, &FRPRMaterialInstanceParameterDetails::ShouldShowExpression, Parameter)));
...
bool FRPRMaterialInstanceParameterDetails::IsVisibleExpression(UDEditorParameterValue* Parameter)
{
	return MaterialEditorInstance->VisibleExpressions.Contains(Parameter->ExpressionId);
}

EVisibility FRPRMaterialInstanceParameterDetails::ShouldShowExpression(UDEditorParameterValue* Parameter) const
{
...
bool FRPRMaterialInstanceParameterDetails::IsOverriddenExpression(UDEditorParameterValue* Parameter)
{
	return Parameter->bOverride != 0;
}

void FRPRMaterialInstanceParameterDetails::OnOverrideParameter(bool NewValue, class UDEditorParameterValue* Parameter)
{
...
bool FRPRMaterialInstanceParameterDetails::OnShouldSetAsset(const FAssetData& AssetData) const
{
...
FText FRPRMaterialInstanceParameterDetails::GetParameterExpressionDescription(UDEditorParameterValue* Parameter) const
{
...
void FRPRMaterialInstanceParameterDetails::ResetToDefault(TSharedPtr<IPropertyHandle> PropertyHandle, class UDEditorParameterValue* Parameter)
{
...
bool FRPRMaterialInstanceParameterDetails::ShouldShowResetToDefault(TSharedPtr<IPropertyHandle> PropertyHandle, class UDEditorParameterValue* Parameter)
{
	FName ParameterName = Parameter->ParameterName;
...
EVisibility FRPRMaterialInstanceParameterDetails::ShouldShowMaterialRefractionSettings() const
{
...
EVisibility FRPRMaterialInstanceParameterDetails::ShouldShowSubsurfaceProfile() const
{
...
void FRPRMaterialInstanceParameterDetails::CreateBasePropertyOverrideWidgets(IDetailLayoutBuilder& DetailLayout)
{
	...
	TAttribute<bool> IsOverrideOpacityClipMaskValueEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OverrideOpacityClipMaskValueEnabled));
	TAttribute<bool> IsOverrideBlendModeEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OverrideBlendModeEnabled));
	TAttribute<bool> IsOverrideShadingModelEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OverrideShadingModelEnabled));
	TAttribute<bool> IsOverrideTwoSidedEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OverrideTwoSidedEnabled));
	TAttribute<bool> IsOverrideDitheredLODTransitionEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OverrideDitheredLODTransitionEnabled));
	...
	OpacityClipMaskValuePropertyRow
		...
		.EditCondition(IsOverrideOpacityClipMaskValueEnabled, FOnBooleanValueChanged::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OnOverrideOpacityClipMaskValueChanged));
	...
	BlendModePropertyRow
		...
		.EditCondition(IsOverrideBlendModeEnabled, FOnBooleanValueChanged::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OnOverrideBlendModeChanged));
	...
	ShadingModelPropertyRow
		...
		.EditCondition(IsOverrideShadingModelEnabled, FOnBooleanValueChanged::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OnOverrideShadingModelChanged));
	...
	TwoSidedPropertyRow
		...
		.EditCondition(IsOverrideTwoSidedEnabled, FOnBooleanValueChanged::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OnOverrideTwoSidedChanged));
	...
	DitheredLODTransitionPropertyRow
		...
		.EditCondition(IsOverrideDitheredLODTransitionEnabled, FOnBooleanValueChanged::CreateSP(this, &FRPRMaterialInstanceParameterDetails::OnOverrideDitheredLODTransitionChanged));
}

bool FRPRMaterialInstanceParameterDetails::OverrideOpacityClipMaskValueEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_OpacityMaskClipValue;
}

bool FRPRMaterialInstanceParameterDetails::OverrideBlendModeEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_BlendMode;
}

bool FRPRMaterialInstanceParameterDetails::OverrideShadingModelEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_ShadingModel;
}

bool FRPRMaterialInstanceParameterDetails::OverrideTwoSidedEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_TwoSided;
}

bool FRPRMaterialInstanceParameterDetails::OverrideDitheredLODTransitionEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_DitheredLODTransition;
}

void FRPRMaterialInstanceParameterDetails::OnOverrideOpacityClipMaskValueChanged(bool NewValue)
{
...
void FRPRMaterialInstanceParameterDetails::OnOverrideBlendModeChanged(bool NewValue)
{
...
void FRPRMaterialInstanceParameterDetails::OnOverrideShadingModelChanged(bool NewValue)
{
...
void FRPRMaterialInstanceParameterDetails::OnOverrideTwoSidedChanged(bool NewValue)
{
...
void FRPRMaterialInstanceParameterDetails::OnOverrideDitheredLODTransitionChanged(bool NewValue)
{
