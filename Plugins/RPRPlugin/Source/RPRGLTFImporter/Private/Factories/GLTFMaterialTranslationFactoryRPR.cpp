...
UObject* UGLTFMaterialTranslationFactoryRPR::FactoryCreateNew(UClass* InClass, UObject* InParent, FName InName, EObjectFlags InFlags, UObject* InContext, FFeedbackContext* InWarn)
{
    ...
    // Create a new blank material which we fill with UMaterialExpressions representing the Uber Material parameters
    ...
    // Translate the UberMaterialParameters into UMaterialExpressions for the output UMaterial
    TranslateRPRUberMaterialParameters(UberMaterialParams);
