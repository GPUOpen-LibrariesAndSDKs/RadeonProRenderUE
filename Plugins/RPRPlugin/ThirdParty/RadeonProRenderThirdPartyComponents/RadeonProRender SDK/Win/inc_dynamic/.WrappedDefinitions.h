...
#define RPR_VERSION_MINOR 33 
#define RPR_VERSION_REVISION 5 
#define RPR_VERSION_BUILD 0xd102ef22 
#define RPR_VERSION_MAJOR_MINOR_REVISION 0x00103305 
...
/* rpr_context_properties */#define RPR_CONTEXT_CREATEPROP_CPU_THREAD_LIMIT 0x600 
#define RPR_CONTEXT_CREATEPROP_COMPILE_CALLBACK 0x601 
#define RPR_CONTEXT_CREATEPROP_COMPILE_USER_DATA 0x602 
#define RPR_CONTEXT_CREATEPROP_SAMPLER_TYPE 0x603 
...
/* rpr_instance_info */#define RPR_INSTANCE_PARENT_SHAPE 0x1601 
...
#define RPR_MATERIAL_INPUT_MAX 0x2d 
/*rpr_material_node_input*/
...
/* rpr_bool */#define RPR_FALSE 0 
#define RPR_TRUE 1 

/* Library types *//* This is going to be moved to rpr_platform.h or similar */typedef char rpr_char;
...
typedef rpr_uint rpr_object_info;
...
typedef rpr_int (*PrprContextSetParameter1f)(rpr_context context, rpr_char const * name, rpr_float x);
typedef rpr_int (*PrprContextSetParameter3f)(rpr_context context, rpr_char const * name, rpr_float x, rpr_float y, rpr_float z);
typedef rpr_int (*PrprContextSetParameter4f)(rpr_context context, rpr_char const * name, rpr_float x, rpr_float y, rpr_float z, rpr_float w);
typedef rpr_int (*PrprContextSetParameterString)(rpr_context context, rpr_char const * name, rpr_char const * value);
...
typedef rpr_int (*PrprCameraSetFocalTilt)(rpr_camera camera, rpr_float tilt);
typedef rpr_int (*PrprCameraSetIPD)(rpr_camera camera, rpr_float ipd);
typedef rpr_int (*PrprCameraSetLensShift)(rpr_camera camera, rpr_float shiftx, rpr_float shifty);
typedef rpr_int (*PrprCameraSetTiltCorrection)(rpr_camera camera, rpr_float tiltX, rpr_float tiltY);
...
/* rpr_shape */
  ...
  extern RPR_API_ENTRY rpr_int rprShapeSetObjectGroupID(rpr_shape shape, rpr_uint objectGroupID);
    ...
    *  @return             RPR_SUCCESS in case of success, error code otherwise
    */
  extern RPR_API_ENTRY rpr_int rprShapeSetLightGroupID(rpr_shape shape, rpr_uint lightGroupID);
  ...
  extern RPR_API_ENTRY rpr_int rprShapeSetMaterial(rpr_shape shape, rpr_material_node node);
    ...
    *  @return		RPR_SUCCESS in case of success, error code otherwise
    */
  extern RPR_API_ENTRY rpr_int rprShapeSetMaterialFaces(rpr_shape shape, rpr_material_node node, rpr_int const * face_indices, size_t num_faces);
  ...
  extern RPR_API_ENTRY rpr_int rprShapeSetScaleMotion(rpr_shape shape, rpr_float x, rpr_float y, rpr_float z);
    ...
    *  @return                  RPR_SUCCESS in case of success, error code otherwise
    */
  extern RPR_API_ENTRY rpr_int rprShapeSetVisibilityFlag(rpr_shape shape, rpr_shape_info visibilityFlag, rpr_bool visible);
...
/* rpr_shape - mesh */
  ...
  extern RPR_API_ENTRY rpr_int rprMeshGetInfo(rpr_shape mesh, rpr_mesh_info mesh_info, size_t size, void * data, size_t * size_ret);
    ...
    *  @return             RPR_SUCCESS in case of success, error code otherwise
    */
  extern RPR_API_ENTRY rpr_int rprCurveGetInfo(rpr_curve curve, rpr_curve_parameter curve_info, size_t size, void * data, size_t * size_ret);
...
typedef rpr_int (*PrprGridGetInfo)(rpr_grid grid, rpr_grid_parameter grid_info, size_t size, void * data, size_t * size_ret);
...
typedef rpr_int (*PrprSceneAttachCurve)(rpr_scene scene, rpr_curve curve);
typedef rpr_int (*PrprSceneDetachCurve)(rpr_scene scene, rpr_curve curve);
typedef rpr_int (*PrprCurveSetMaterial)(rpr_curve curve, rpr_material_node material);
typedef rpr_int (*PrprCurveSetTransform)(rpr_curve curve, rpr_bool transpose, rpr_float const * transform);
    ...
    *
    */
  extern RPR_API_ENTRY rpr_int rprContextCreateCurve(rpr_context context, rpr_curve * out_curve, size_t num_controlPoints, rpr_float const * controlPointsData, rpr_int controlPointsStride, size_t num_indices, rpr_uint curveCount, rpr_uint const * indicesData, rpr_float const * radius, rpr_float const * textureUV, rpr_int const * segmentPerCurve);
...
typedef rpr_int (*PrprMaterialNodeSetInputBufferData)(rpr_material_node in_node, rpr_char const * in_input, rpr_buffer buffer);
typedef rpr_int (*PrprMaterialNodeGetInfo)(rpr_material_node in_node, rpr_material_node_info in_info, size_t in_size, void * in_data, size_t * out_size);
typedef rpr_int (*PrprMaterialNodeGetInputInfo)(rpr_material_node in_node, rpr_int in_input_idx, rpr_material_node_input_info in_info, size_t in_size, void * in_data, size_t * out_size);
typedef rpr_int (*PrprContextCreateComposite)(rpr_context context, rpr_composite_type in_type, rpr_composite * out_composite);
typedef rpr_int (*PrprContextCreateLUTFromFile)(rpr_context context, const rpr_char * fileLutPath, rpr_lut * out_lut);
typedef rpr_int (*PrprContextCreateLUTFromData)(rpr_context context, const rpr_char * lutData, rpr_lut * out_lut);
typedef rpr_int (*PrprCompositeSetInputFb)(rpr_composite composite, const rpr_char * inputName, rpr_framebuffer input);
typedef rpr_int (*PrprCompositeSetInputC)(rpr_composite composite, const rpr_char * inputName, rpr_composite input);
typedef rpr_int (*PrprCompositeSetInputLUT)(rpr_composite composite, const rpr_char * inputName, rpr_lut input);
typedef rpr_int (*PrprCompositeSetInput4f)(rpr_composite composite, const rpr_char * inputName, float x, float y, float z, float w);
typedef rpr_int (*PrprCompositeSetInput1u)(rpr_composite composite, const rpr_char * inputName, rpr_uint value);
typedef rpr_int (*PrprCompositeSetInputOp)(rpr_composite composite, const rpr_char * inputName, rpr_material_node_arithmetic_operation op);
typedef rpr_int (*PrprCompositeCompute)(rpr_composite composite, rpr_framebuffer fb);
typedef rpr_int (*PrprCompositeGetInfo)(rpr_composite composite, rpr_composite_info composite_info, size_t size, void *  data, size_t * size_ret);
...
typedef rpr_int (*PrprContextAttachPostEffect)(rpr_context context, rpr_post_effect effect);
typedef rpr_int (*PrprContextDetachPostEffect)(rpr_context context, rpr_post_effect effect);
typedef rpr_int (*PrprPostEffectSetParameter1u)(rpr_post_effect effect, rpr_char const * name, rpr_uint x);
typedef rpr_int (*PrprPostEffectSetParameter1f)(rpr_post_effect effect, rpr_char const * name, rpr_float x);
typedef rpr_int (*PrprPostEffectSetParameter3f)(rpr_post_effect effect, rpr_char const * name, rpr_float x, rpr_float y, rpr_float z);
typedef rpr_int (*PrprPostEffectSetParameter4f)(rpr_post_effect effect, rpr_char const * name, rpr_float x, rpr_float y, rpr_float z, rpr_float w);
typedef rpr_int (*PrprContextGetAttachedPostEffectCount)(rpr_context context, rpr_uint *  nb);
typedef rpr_int (*PrprContextGetAttachedPostEffect)(rpr_context context, rpr_uint i, rpr_post_effect * out_effect);
typedef rpr_int (*PrprPostEffectGetInfo)(rpr_post_effect effect, rpr_post_effect_info info, size_t size,  void *  data, size_t *  size_ret);
typedef rpr_int (*PrprContextCreateGrid)(rpr_context context, rpr_grid * out_grid, size_t gridSizeX, size_t gridSizeY, size_t gridSizeZ, void const * indicesList, size_t numberOfIndices, rpr_grid_indices_topology indicesListTopology, void const * gridData, size_t gridDataSizeByte, rpr_uint gridDataTopology___unused);
typedef rpr_int (*PrprContextCreateHeteroVolume)(rpr_context context, rpr_hetero_volume * out_heteroVolume);
typedef rpr_int (*PrprShapeSetHeteroVolume)(rpr_shape shape, rpr_hetero_volume heteroVolume);
typedef rpr_int (*PrprHeteroVolumeSetTransform)(rpr_hetero_volume heteroVolume, rpr_bool transpose, rpr_float const * transform);
typedef rpr_int (*PrprHeteroVolumeSetEmissionGrid)(rpr_hetero_volume heteroVolume, rpr_grid grid);
typedef rpr_int (*PrprHeteroVolumeSetDensityGrid)(rpr_hetero_volume heteroVolume, rpr_grid grid);
typedef rpr_int (*PrprHeteroVolumeSetAlbedoGrid)(rpr_hetero_volume heteroVolume, rpr_grid grid);
typedef rpr_int (*PrprHeteroVolumeSetEmissionLookup)(rpr_hetero_volume heteroVolume, rpr_float const * ptr, rpr_uint n);
typedef rpr_int (*PrprHeteroVolumeSetDensityLookup)(rpr_hetero_volume heteroVolume, rpr_float const * ptr, rpr_uint n);
typedef rpr_int (*PrprHeteroVolumeSetAlbedoLookup)(rpr_hetero_volume heteroVolume, rpr_float const * ptr, rpr_uint n);
typedef rpr_int (*PrprHeteroVolumeSetAlbedoScale)(rpr_hetero_volume heteroVolume, rpr_float scale);
typedef rpr_int (*PrprHeteroVolumeSetEmissionScale)(rpr_hetero_volume heteroVolume, rpr_float scale);
typedef rpr_int (*PrprHeteroVolumeSetDensityScale)(rpr_hetero_volume heteroVolume, rpr_float scale);
/***************compatibility part***************/
#define FR_VERSION_MAJOR 1 
#define FR_VERSION_MINOR 33 
#define FR_VERSION_REVISION 5 
#define FR_VERSION_BUILD 0xd102ef22 
#define FR_VERSION_MAJOR_MINOR_REVISION 0x00103305 
...
#define FR_CONTEXT_CREATEPROP_SAMPLER_TYPE 0x603 
...
#define FR_MATERIAL_INPUT_MAX 0x2d 
...
typedef rpr_object_info fr_object_info;
...
typedef fr_int (*PfrRegisterPlugin)(fr_char const * path);
typedef fr_int (*PfrCreateContext)(fr_int api_version, fr_int * pluginIDs, size_t pluginCount, fr_creation_flags creation_flags, fr_context_properties const * props, fr_char const * cache_path, fr_context * out_context);
typedef fr_int (*PfrContextSetActivePlugin)(fr_context context, fr_int pluginID);
typedef fr_int (*PfrContextGetInfo)(fr_context context, fr_context_info context_info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrContextGetParameterInfo)(fr_context context, int param_idx, fr_parameter_info parameter_info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrContextGetAOV)(fr_context context, fr_aov aov, fr_framebuffer * out_fb);
typedef fr_int (*PfrContextSetAOV)(fr_context context, fr_aov aov, fr_framebuffer frame_buffer);
typedef fr_int (*PfrContextSetAOVindexLookup)(fr_context context, fr_int key, fr_float colorR, fr_float colorG, fr_float colorB, fr_float colorA);
typedef fr_int (*PfrContextSetScene)(fr_context context, fr_scene scene);
typedef fr_int (*PfrContextGetScene)(fr_context arg0, fr_scene * out_scene);
typedef fr_int (*PfrContextSetParameter1u)(fr_context context, fr_char const * name, fr_uint x);
typedef fr_int (*PfrContextSetParameter1f)(fr_context context, fr_char const * name, fr_float x);
typedef fr_int (*PfrContextSetParameter3f)(fr_context context, fr_char const * name, fr_float x, fr_float y, fr_float z);
typedef fr_int (*PfrContextSetParameter4f)(fr_context context, fr_char const * name, fr_float x, fr_float y, fr_float z, fr_float w);
typedef fr_int (*PfrContextSetParameterString)(fr_context context, fr_char const * name, fr_char const * value);
typedef fr_int (*PfrContextRender)(fr_context context);
typedef fr_int (*PfrContextAbortRender)(fr_context context);
typedef fr_int (*PfrContextRenderTile)(fr_context context, fr_uint xmin, fr_uint xmax, fr_uint ymin, fr_uint ymax);
typedef fr_int (*PfrContextClearMemory)(fr_context context);
typedef fr_int (*PfrContextCreateImage)(fr_context context, fr_image_format const format, fr_image_desc const * image_desc, void const * data, fr_image * out_image);
typedef fr_int (*PfrContextCreateBuffer)(fr_context context, fr_buffer_desc const * buffer_desc, void const * data, fr_buffer * out_buffer);
typedef fr_int (*PfrContextCreateImageFromFile)(fr_context context, fr_char const * path, fr_image * out_image);
typedef fr_int (*PfrContextCreateScene)(fr_context context, fr_scene * out_scene);
typedef fr_int (*PfrContextCreateInstance)(fr_context context, fr_shape shape, fr_shape * out_instance);
typedef fr_int (*PfrContextCreateMesh)(fr_context context, fr_float const * vertices, size_t num_vertices, fr_int vertex_stride, fr_float const * normals, size_t num_normals, fr_int normal_stride, fr_float const * texcoords, size_t num_texcoords, fr_int texcoord_stride, fr_int const * vertex_indices, fr_int vidx_stride, fr_int const * normal_indices, fr_int nidx_stride, fr_int const * texcoord_indices, fr_int tidx_stride, fr_int const * num_face_vertices, size_t num_faces, fr_shape * out_mesh);
typedef fr_int (*PfrContextCreateMeshEx)(fr_context context, fr_float const * vertices, size_t num_vertices, fr_int vertex_stride, fr_float const * normals, size_t num_normals, fr_int normal_stride, fr_int const * perVertexFlag, size_t num_perVertexFlags, fr_int perVertexFlag_stride, fr_int numberOfTexCoordLayers, fr_float const ** texcoords, size_t const * num_texcoords, fr_int const * texcoord_stride, fr_int const * vertex_indices, fr_int vidx_stride, fr_int const * normal_indices, fr_int nidx_stride, fr_int const ** texcoord_indices, fr_int const * tidx_stride, fr_int const * num_face_vertices, size_t num_faces, fr_shape * out_mesh);
typedef fr_int (*PfrContextCreateMeshEx2)(fr_context context, fr_float const * vertices, size_t num_vertices, fr_int vertex_stride, fr_float const * normals, size_t num_normals, fr_int normal_stride, fr_int const * perVertexFlag, size_t num_perVertexFlags, fr_int perVertexFlag_stride, fr_int numberOfTexCoordLayers, fr_float const ** texcoords, size_t const * num_texcoords, fr_int const * texcoord_stride, fr_int const * vertex_indices, fr_int vidx_stride, fr_int const * normal_indices, fr_int nidx_stride, fr_int const ** texcoord_indices, fr_int const * tidx_stride, fr_int const * num_face_vertices, size_t num_faces, fr_mesh_info const * mesh_properties, fr_shape * out_mesh);
typedef fr_int (*PfrContextCreateCamera)(fr_context context, fr_camera * out_camera);
typedef fr_int (*PfrContextCreateFrameBuffer)(fr_context context, fr_framebuffer_format const format, fr_framebuffer_desc const * fb_desc, fr_framebuffer * out_fb);
typedef fr_int (*PfrCameraGetInfo)(fr_camera camera, fr_camera_info camera_info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrCameraSetFocalLength)(fr_camera camera, fr_float flength);
typedef fr_int (*PfrCameraSetLinearMotion)(fr_camera camera, fr_float x, fr_float y, fr_float z);
typedef fr_int (*PfrCameraSetAngularMotion)(fr_camera camera, fr_float x, fr_float y, fr_float z, fr_float w);
typedef fr_int (*PfrCameraSetFocusDistance)(fr_camera camera, fr_float fdist);
typedef fr_int (*PfrCameraSetTransform)(fr_camera camera, fr_bool transpose, fr_float * transform);
typedef fr_int (*PfrCameraSetSensorSize)(fr_camera camera, fr_float width, fr_float height);
typedef fr_int (*PfrCameraLookAt)(fr_camera camera, fr_float posx, fr_float posy, fr_float posz, fr_float atx, fr_float aty, fr_float atz, fr_float upx, fr_float upy, fr_float upz);
typedef fr_int (*PfrCameraSetFStop)(fr_camera camera, fr_float fstop);
typedef fr_int (*PfrCameraSetApertureBlades)(fr_camera camera, fr_uint num_blades);
typedef fr_int (*PfrCameraSetExposure)(fr_camera camera, fr_float exposure);
typedef fr_int (*PfrCameraSetMode)(fr_camera camera, fr_camera_mode mode);
typedef fr_int (*PfrCameraSetOrthoWidth)(fr_camera camera, fr_float width);
typedef fr_int (*PfrCameraSetFocalTilt)(fr_camera camera, fr_float tilt);
typedef fr_int (*PfrCameraSetIPD)(fr_camera camera, fr_float ipd);
typedef fr_int (*PfrCameraSetLensShift)(fr_camera camera, fr_float shiftx, fr_float shifty);
typedef fr_int (*PfrCameraSetTiltCorrection)(fr_camera camera, fr_float tiltX, fr_float tiltY);
typedef fr_int (*PfrCameraSetOrthoHeight)(fr_camera camera, fr_float height);
typedef fr_int (*PfrCameraSetNearPlane)(fr_camera camera, fr_float near);
typedef fr_int (*PfrCameraSetFarPlane)(fr_camera camera, fr_float far);
typedef fr_int (*PfrImageGetInfo)(fr_image image, fr_image_info image_info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrImageSetWrap)(fr_image image, fr_image_wrap_type type);
typedef fr_int (*PfrImageSetFilter)(fr_image image, fr_image_filter_type type);
typedef fr_int (*PfrImageSetGamma)(fr_image image, fr_float type);
typedef fr_int (*PfrImageSetMipmapEnabled)(fr_image image, fr_bool enabled);
typedef fr_int (*PfrShapeSetTransform)(fr_shape shape, fr_bool transpose, fr_float const * transform);
typedef fr_int (*PfrShapeSetSubdivisionFactor)(fr_shape shape, fr_uint factor);
typedef fr_int (*PfrShapeSetSubdivisionCreaseWeight)(fr_shape shape, fr_float factor);
typedef fr_int (*PfrShapeSetSubdivisionBoundaryInterop)(fr_shape shape, fr_subdiv_boundary_interfop_type type);
typedef fr_int (*PfrShapeAutoAdaptSubdivisionFactor)(fr_shape shape, fr_framebuffer framebuffer, fr_camera camera, fr_int factor);
typedef fr_int (*PfrShapeSetDisplacementScale)(fr_shape shape, fr_float minscale, fr_float maxscale);
typedef fr_int (*PfrShapeSetObjectGroupID)(fr_shape shape, fr_uint objectGroupID);
typedef fr_int (*PfrShapeSetLightGroupID)(fr_shape shape, fr_uint lightGroupID);
typedef fr_int (*PfrShapeSetLayerMask)(fr_shape shape, fr_uint layerMask);
typedef fr_int (*PfrShapeSetDisplacementMaterial)(fr_shape shape, fr_material_node materialNode);
typedef fr_int (*PfrShapeSetMaterial)(fr_shape shape, fr_material_node node);
typedef fr_int (*PfrShapeSetMaterialFaces)(fr_shape shape, fr_material_node node, fr_int const * face_indices, size_t num_faces);
typedef fr_int (*PfrShapeSetVolumeMaterial)(fr_shape shape, fr_material_node node);
typedef fr_int (*PfrShapeSetLinearMotion)(fr_shape shape, fr_float x, fr_float y, fr_float z);
typedef fr_int (*PfrShapeSetAngularMotion)(fr_shape shape, fr_float x, fr_float y, fr_float z, fr_float w);
typedef fr_int (*PfrShapeSetScaleMotion)(fr_shape shape, fr_float x, fr_float y, fr_float z);
typedef fr_int (*PfrShapeSetVisibilityFlag)(fr_shape shape, fr_shape_info visibilityFlag, fr_bool visible);
typedef fr_int (*PfrShapeSetVisibility)(fr_shape shape, fr_bool visible);
typedef fr_int (*PfrShapeSetVisibilityInSpecular)(fr_shape shape, fr_bool visible);
typedef fr_int (*PfrShapeSetShadowCatcher)(fr_shape shape, fr_bool shadowCatcher);
typedef fr_int (*PfrLightSetTransform)(fr_light light, fr_bool transpose, fr_float const * transform);
typedef fr_int (*PfrLightSetGroupId)(fr_light light, fr_uint groupId);
typedef fr_int (*PfrShapeGetInfo)(fr_shape arg0, fr_shape_info arg1, size_t arg2, void * arg3, size_t * arg4);
typedef fr_int (*PfrMeshGetInfo)(fr_shape mesh, fr_mesh_info mesh_info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrCurveGetInfo)(fr_curve curve, fr_curve_parameter curve_info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrHeteroVolumeGetInfo)(fr_hetero_volume heteroVol, fr_hetero_volume_parameter heteroVol_info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrGridGetInfo)(fr_grid grid, fr_grid_parameter grid_info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrBufferGetInfo)(fr_buffer buffer, fr_buffer_info buffer_info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrMeshPolygonGetInfo)(fr_shape mesh, size_t polygon_index, fr_mesh_polygon_info polygon_info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrInstanceGetBaseShape)(fr_shape shape, fr_shape * out_shape);
typedef fr_int (*PfrContextCreatePointLight)(fr_context context, fr_light * out_light);
typedef fr_int (*PfrPointLightSetRadiantPower3f)(fr_light light, fr_float r, fr_float g, fr_float b);
typedef fr_int (*PfrContextCreateSpotLight)(fr_context context, fr_light * light);
typedef fr_int (*PfrSpotLightSetRadiantPower3f)(fr_light light, fr_float r, fr_float g, fr_float b);
typedef fr_int (*PfrSpotLightSetConeShape)(fr_light light, fr_float iangle, fr_float oangle);
typedef fr_int (*PfrContextCreateDirectionalLight)(fr_context context, fr_light * out_light);
typedef fr_int (*PfrDirectionalLightSetRadiantPower3f)(fr_light light, fr_float r, fr_float g, fr_float b);
typedef fr_int (*PfrDirectionalLightSetShadowSoftness)(fr_light light, fr_float coeff);
typedef fr_int (*PfrContextCreateEnvironmentLight)(fr_context context, fr_light * out_light);
typedef fr_int (*PfrEnvironmentLightSetImage)(fr_light env_light, fr_image image);
typedef fr_int (*PfrEnvironmentLightSetIntensityScale)(fr_light env_light, fr_float intensity_scale);
typedef fr_int (*PfrEnvironmentLightAttachPortal)(fr_scene scene, fr_light env_light, fr_shape portal);
typedef fr_int (*PfrEnvironmentLightDetachPortal)(fr_scene scene, fr_light env_light, fr_shape portal);
typedef fr_int (*PfrContextCreateSkyLight)(fr_context context, fr_light * out_light);
typedef fr_int (*PfrSkyLightSetTurbidity)(fr_light skylight, fr_float turbidity);
typedef fr_int (*PfrSkyLightSetAlbedo)(fr_light skylight, fr_float albedo);
typedef fr_int (*PfrSkyLightSetScale)(fr_light skylight, fr_float scale);
typedef fr_int (*PfrSkyLightSetDirection)(fr_light skylight, fr_float x, fr_float y, fr_float z);
typedef fr_int (*PfrSkyLightAttachPortal)(fr_scene scene, fr_light skylight, fr_shape portal);
typedef fr_int (*PfrSkyLightDetachPortal)(fr_scene scene, fr_light skylight, fr_shape portal);
typedef fr_int (*PfrContextCreateIESLight)(fr_context context, fr_light * light);
typedef fr_int (*PfrIESLightSetRadiantPower3f)(fr_light light, fr_float r, fr_float g, fr_float b);
typedef fr_int (*PfrIESLightSetImageFromFile)(fr_light env_light, fr_char const * imagePath, fr_int nx, fr_int ny);
typedef fr_int (*PfrIESLightSetImageFromIESdata)(fr_light env_light, fr_char const * iesData, fr_int nx, fr_int ny);
typedef fr_int (*PfrLightGetInfo)(fr_light light, fr_light_info info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrSceneClear)(fr_scene scene);
typedef fr_int (*PfrSceneAttachShape)(fr_scene scene, fr_shape shape);
typedef fr_int (*PfrSceneDetachShape)(fr_scene scene, fr_shape shape);
typedef fr_int (*PfrSceneAttachHeteroVolume)(fr_scene scene, fr_hetero_volume heteroVolume);
typedef fr_int (*PfrSceneDetachHeteroVolume)(fr_scene scene, fr_hetero_volume heteroVolume);
typedef fr_int (*PfrSceneAttachCurve)(fr_scene scene, fr_curve curve);
typedef fr_int (*PfrSceneDetachCurve)(fr_scene scene, fr_curve curve);
typedef fr_int (*PfrCurveSetMaterial)(fr_curve curve, fr_material_node material);
typedef fr_int (*PfrCurveSetTransform)(fr_curve curve, fr_bool transpose, fr_float const * transform);
typedef fr_int (*PfrContextCreateCurve)(fr_context context, fr_curve * out_curve, size_t num_controlPoints, fr_float const * controlPointsData, fr_int controlPointsStride, size_t num_indices, fr_uint curveCount, fr_uint const * indicesData, fr_float const * radius, fr_float const * textureUV, fr_int const * segmentPerCurve);
typedef fr_int (*PfrSceneAttachLight)(fr_scene scene, fr_light light);
typedef fr_int (*PfrSceneDetachLight)(fr_scene scene, fr_light light);
typedef fr_int (*PfrSceneGetInfo)(fr_scene scene, fr_scene_info info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrSceneGetEnvironmentOverride)(fr_scene scene, fr_environment_override overrride, fr_light * out_light);
typedef fr_int (*PfrSceneSetEnvironmentOverride)(fr_scene scene, fr_environment_override overrride, fr_light light);
typedef fr_int (*PfrSceneSetBackgroundImage)(fr_scene scene, fr_image image);
typedef fr_int (*PfrSceneGetBackgroundImage)(fr_scene scene, fr_image * out_image);
typedef fr_int (*PfrSceneSetCamera)(fr_scene scene, fr_camera camera);
typedef fr_int (*PfrSceneGetCamera)(fr_scene scene, fr_camera * out_camera);
typedef fr_int (*PfrFrameBufferGetInfo)(fr_framebuffer framebuffer, fr_framebuffer_info info, size_t size, void * data, size_t * size_ret);
typedef fr_int (*PfrFrameBufferClear)(fr_framebuffer frame_buffer);
typedef fr_int (*PfrFrameBufferSaveToFile)(fr_framebuffer frame_buffer, fr_char const * file_path);
typedef fr_int (*PfrContextResolveFrameBuffer)(fr_context context, fr_framebuffer src_frame_buffer, fr_framebuffer dst_frame_buffer, fr_bool normalizeOnly);
typedef fr_int (*PfrContextCreateMaterialSystem)(fr_context in_context, fr_material_system_type type, fr_material_system * out_matsys);
typedef fr_int (*PfrMaterialSystemGetSize)(fr_context in_context, fr_uint * out_size);
typedef fr_int (*PfrMaterialSystemCreateNode)(fr_material_system in_matsys, fr_material_node_type in_type, fr_material_node * out_node);
typedef fr_int (*PfrMaterialNodeSetInputN)(fr_material_node in_node, fr_char const * in_input, fr_material_node in_input_node);
typedef fr_int (*PfrMaterialNodeSetInputF)(fr_material_node in_node, fr_char const * in_input, fr_float in_value_x, fr_float in_value_y, fr_float in_value_z, fr_float in_value_w);
typedef fr_int (*PfrMaterialNodeSetInputU)(fr_material_node in_node, fr_char const * in_input, fr_uint in_value);
typedef fr_int (*PfrMaterialNodeSetInputImageData)(fr_material_node in_node, fr_char const * in_input, fr_image image);
typedef fr_int (*PfrMaterialNodeSetInputBufferData)(fr_material_node in_node, fr_char const * in_input, fr_buffer buffer);
typedef fr_int (*PfrMaterialNodeGetInfo)(fr_material_node in_node, fr_material_node_info in_info, size_t in_size, void * in_data, size_t * out_size);
typedef fr_int (*PfrMaterialNodeGetInputInfo)(fr_material_node in_node, fr_int in_input_idx, fr_material_node_input_info in_info, size_t in_size, void * in_data, size_t * out_size);
typedef fr_int (*PfrContextCreateComposite)(fr_context context, fr_composite_type in_type, fr_composite * out_composite);
typedef fr_int (*PfrContextCreateLUTFromFile)(fr_context context, const fr_char * fileLutPath, fr_lut * out_lut);
typedef fr_int (*PfrContextCreateLUTFromData)(fr_context context, const fr_char * lutData, fr_lut * out_lut);
typedef fr_int (*PfrCompositeSetInputFb)(fr_composite composite, const fr_char * inputName, fr_framebuffer input);
typedef fr_int (*PfrCompositeSetInputC)(fr_composite composite, const fr_char * inputName, fr_composite input);
typedef fr_int (*PfrCompositeSetInputLUT)(fr_composite composite, const fr_char * inputName, fr_lut input);
typedef fr_int (*PfrCompositeSetInput4f)(fr_composite composite, const fr_char * inputName, float x, float y, float z, float w);
typedef fr_int (*PfrCompositeSetInput1u)(fr_composite composite, const fr_char * inputName, fr_uint value);
typedef fr_int (*PfrCompositeSetInputOp)(fr_composite composite, const fr_char * inputName, fr_material_node_arithmetic_operation op);
typedef fr_int (*PfrCompositeCompute)(fr_composite composite, fr_framebuffer fb);
typedef fr_int (*PfrCompositeGetInfo)(fr_composite composite, fr_composite_info composite_info, size_t size, void *  data, size_t * size_ret);
typedef fr_int (*PfrObjectDelete)(void * obj);
typedef fr_int (*PfrObjectSetName)(void * node, fr_char const * name);
typedef fr_int (*PfrContextCreatePostEffect)(fr_context context, fr_post_effect_type type, fr_post_effect * out_effect);
typedef fr_int (*PfrContextAttachPostEffect)(fr_context context, fr_post_effect effect);
typedef fr_int (*PfrContextDetachPostEffect)(fr_context context, fr_post_effect effect);
typedef fr_int (*PfrPostEffectSetParameter1u)(fr_post_effect effect, fr_char const * name, fr_uint x);
typedef fr_int (*PfrPostEffectSetParameter1f)(fr_post_effect effect, fr_char const * name, fr_float x);
typedef fr_int (*PfrPostEffectSetParameter3f)(fr_post_effect effect, fr_char const * name, fr_float x, fr_float y, fr_float z);
typedef fr_int (*PfrPostEffectSetParameter4f)(fr_post_effect effect, fr_char const * name, fr_float x, fr_float y, fr_float z, fr_float w);
typedef fr_int (*PfrContextGetAttachedPostEffectCount)(fr_context context, fr_uint *  nb);
typedef fr_int (*PfrContextGetAttachedPostEffect)(fr_context context, fr_uint i, fr_post_effect * out_effect);
typedef fr_int (*PfrPostEffectGetInfo)(fr_post_effect effect, fr_post_effect_info info, size_t size,  void *  data, size_t *  size_ret);
typedef fr_int (*PfrContextCreateGrid)(fr_context context, fr_grid * out_grid, size_t gridSizeX, size_t gridSizeY, size_t gridSizeZ, void const * indicesList, size_t numberOfIndices, fr_grid_indices_topology indicesListTopology, void const * gridData, size_t gridDataSizeByte, fr_uint gridDataTopology___unused);
typedef fr_int (*PfrContextCreateHeteroVolume)(fr_context context, fr_hetero_volume * out_heteroVolume);
typedef fr_int (*PfrShapeSetHeteroVolume)(fr_shape shape, fr_hetero_volume heteroVolume);
typedef fr_int (*PfrHeteroVolumeSetTransform)(fr_hetero_volume heteroVolume, fr_bool transpose, fr_float const * transform);
typedef fr_int (*PfrHeteroVolumeSetEmissionGrid)(fr_hetero_volume heteroVolume, fr_grid grid);
typedef fr_int (*PfrHeteroVolumeSetDensityGrid)(fr_hetero_volume heteroVolume, fr_grid grid);
typedef fr_int (*PfrHeteroVolumeSetAlbedoGrid)(fr_hetero_volume heteroVolume, fr_grid grid);
typedef fr_int (*PfrHeteroVolumeSetEmissionLookup)(fr_hetero_volume heteroVolume, fr_float const * ptr, fr_uint n);
typedef fr_int (*PfrHeteroVolumeSetDensityLookup)(fr_hetero_volume heteroVolume, fr_float const * ptr, fr_uint n);
typedef fr_int (*PfrHeteroVolumeSetAlbedoLookup)(fr_hetero_volume heteroVolume, fr_float const * ptr, fr_uint n);
typedef fr_int (*PfrHeteroVolumeSetAlbedoScale)(fr_hetero_volume heteroVolume, fr_float scale);
typedef fr_int (*PfrHeteroVolumeSetEmissionScale)(fr_hetero_volume heteroVolume, fr_float scale);
typedef fr_int (*PfrHeteroVolumeSetDensityScale)(fr_hetero_volume heteroVolume, fr_float scale);
