...
/* Error codes  */#define RPR_INVALID_GL_SHAREGROUP_REFERENCE_KHR -1000 

/* rpr_context_properties  */#define RPR_GL_CONTEXT_KHR 0x2001 
...
typedef rpr_int (*PrprContextCreateFramebufferFromGLTexture2D)(rpr_context context, rpr_GLenum target, rpr_GLint miplevel, rpr_GLuint texture, rpr_framebuffer * out_fb);
/***************compatibility part***************/
...
typedef fr_int (*PfrContextCreateFramebufferFromGLTexture2D)(fr_context context, fr_GLenum target, fr_GLint miplevel, fr_GLuint texture, fr_framebuffer * out_fb);
