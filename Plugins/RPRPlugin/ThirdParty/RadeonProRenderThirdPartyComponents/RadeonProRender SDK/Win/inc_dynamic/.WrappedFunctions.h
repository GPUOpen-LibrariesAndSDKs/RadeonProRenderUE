...
RPR_DECL(rprContextSetParameter1f);
RPR_DECL(rprContextSetParameter3f);
RPR_DECL(rprContextSetParameter4f);
RPR_DECL(rprContextSetParameterString);
...
RPR_DECL(rprCameraSetFocalTilt);
RPR_DECL(rprCameraSetIPD);
RPR_DECL(rprCameraSetLensShift);
RPR_DECL(rprCameraSetTiltCorrection);
...
RPR_DECL(rprSceneAttachCurve);
RPR_DECL(rprSceneDetachCurve);
RPR_DECL(rprCurveSetMaterial);
RPR_DECL(rprCurveSetTransform);
...
RPR_DECL(rprMaterialNodeSetInputBufferData);
RPR_DECL(rprMaterialNodeGetInfo);
RPR_DECL(rprMaterialNodeGetInputInfo);
RPR_DECL(rprContextCreateComposite);
RPR_DECL(rprContextCreateLUTFromFile);
RPR_DECL(rprContextCreateLUTFromData);
RPR_DECL(rprCompositeSetInputFb);
RPR_DECL(rprCompositeSetInputC);
RPR_DECL(rprCompositeSetInputLUT);
RPR_DECL(rprCompositeSetInput4f);
RPR_DECL(rprCompositeSetInput1u);
RPR_DECL(rprCompositeSetInputOp);
RPR_DECL(rprCompositeCompute);
RPR_DECL(rprCompositeGetInfo);
...
RPR_DECL(rprContextAttachPostEffect);
RPR_DECL(rprContextDetachPostEffect);
RPR_DECL(rprPostEffectSetParameter1u);
RPR_DECL(rprPostEffectSetParameter1f);
RPR_DECL(rprPostEffectSetParameter3f);
RPR_DECL(rprPostEffectSetParameter4f);
RPR_DECL(rprContextGetAttachedPostEffectCount);
RPR_DECL(rprContextGetAttachedPostEffect);
RPR_DECL(rprPostEffectGetInfo);
RPR_DECL(rprContextCreateGrid);
RPR_DECL(rprContextCreateHeteroVolume);
RPR_DECL(rprShapeSetHeteroVolume);
RPR_DECL(rprHeteroVolumeSetTransform);
RPR_DECL(rprHeteroVolumeSetEmissionGrid);
RPR_DECL(rprHeteroVolumeSetDensityGrid);
RPR_DECL(rprHeteroVolumeSetAlbedoGrid);
RPR_DECL(rprHeteroVolumeSetEmissionLookup);
RPR_DECL(rprHeteroVolumeSetDensityLookup);
RPR_DECL(rprHeteroVolumeSetAlbedoLookup);
RPR_DECL(rprHeteroVolumeSetAlbedoScale);
RPR_DECL(rprHeteroVolumeSetEmissionScale);
RPR_DECL(rprHeteroVolumeSetDensityScale);
// /***************compatibility part***************/
...
RPR_DECL(frRegisterPlugin);
RPR_DECL(frCreateContext);
RPR_DECL(frContextSetActivePlugin);
RPR_DECL(frContextGetInfo);
RPR_DECL(frContextGetParameterInfo);
RPR_DECL(frContextGetAOV);
RPR_DECL(frContextSetAOV);
RPR_DECL(frContextSetAOVindexLookup);
RPR_DECL(frContextSetScene);
RPR_DECL(frContextGetScene);
RPR_DECL(frContextSetParameter1u);
RPR_DECL(frContextSetParameter1f);
RPR_DECL(frContextSetParameter3f);
RPR_DECL(frContextSetParameter4f);
RPR_DECL(frContextSetParameterString);
RPR_DECL(frContextRender);
RPR_DECL(frContextAbortRender);
RPR_DECL(frContextRenderTile);
RPR_DECL(frContextClearMemory);
RPR_DECL(frContextCreateImage);
RPR_DECL(frContextCreateBuffer);
RPR_DECL(frContextCreateImageFromFile);
RPR_DECL(frContextCreateScene);
RPR_DECL(frContextCreateInstance);
RPR_DECL(frContextCreateMesh);
RPR_DECL(frContextCreateMeshEx);
RPR_DECL(frContextCreateMeshEx2);
RPR_DECL(frContextCreateCamera);
RPR_DECL(frContextCreateFrameBuffer);
RPR_DECL(frCameraGetInfo);
RPR_DECL(frCameraSetFocalLength);
RPR_DECL(frCameraSetLinearMotion);
RPR_DECL(frCameraSetAngularMotion);
RPR_DECL(frCameraSetFocusDistance);
RPR_DECL(frCameraSetTransform);
RPR_DECL(frCameraSetSensorSize);
RPR_DECL(frCameraLookAt);
RPR_DECL(frCameraSetFStop);
RPR_DECL(frCameraSetApertureBlades);
RPR_DECL(frCameraSetExposure);
RPR_DECL(frCameraSetMode);
RPR_DECL(frCameraSetOrthoWidth);
RPR_DECL(frCameraSetFocalTilt);
RPR_DECL(frCameraSetIPD);
RPR_DECL(frCameraSetLensShift);
RPR_DECL(frCameraSetTiltCorrection);
RPR_DECL(frCameraSetOrthoHeight);
RPR_DECL(frCameraSetNearPlane);
RPR_DECL(frCameraSetFarPlane);
RPR_DECL(frImageGetInfo);
RPR_DECL(frImageSetWrap);
RPR_DECL(frImageSetFilter);
RPR_DECL(frImageSetGamma);
RPR_DECL(frImageSetMipmapEnabled);
RPR_DECL(frShapeSetTransform);
RPR_DECL(frShapeSetSubdivisionFactor);
RPR_DECL(frShapeSetSubdivisionCreaseWeight);
RPR_DECL(frShapeSetSubdivisionBoundaryInterop);
RPR_DECL(frShapeAutoAdaptSubdivisionFactor);
RPR_DECL(frShapeSetDisplacementScale);
RPR_DECL(frShapeSetObjectGroupID);
RPR_DECL(frShapeSetLightGroupID);
RPR_DECL(frShapeSetLayerMask);
RPR_DECL(frShapeSetDisplacementMaterial);
RPR_DECL(frShapeSetMaterial);
RPR_DECL(frShapeSetMaterialFaces);
RPR_DECL(frShapeSetVolumeMaterial);
RPR_DECL(frShapeSetLinearMotion);
RPR_DECL(frShapeSetAngularMotion);
RPR_DECL(frShapeSetScaleMotion);
RPR_DECL(frShapeSetVisibilityFlag);
RPR_DECL(frShapeSetVisibility);
RPR_DECL(frShapeSetVisibilityInSpecular);
RPR_DECL(frShapeSetShadowCatcher);
RPR_DECL(frLightSetTransform);
RPR_DECL(frLightSetGroupId);
RPR_DECL(frShapeGetInfo);
RPR_DECL(frMeshGetInfo);
RPR_DECL(frCurveGetInfo);
RPR_DECL(frHeteroVolumeGetInfo);
RPR_DECL(frGridGetInfo);
RPR_DECL(frBufferGetInfo);
RPR_DECL(frMeshPolygonGetInfo);
RPR_DECL(frInstanceGetBaseShape);
RPR_DECL(frContextCreatePointLight);
RPR_DECL(frPointLightSetRadiantPower3f);
RPR_DECL(frContextCreateSpotLight);
RPR_DECL(frSpotLightSetRadiantPower3f);
RPR_DECL(frSpotLightSetConeShape);
RPR_DECL(frContextCreateDirectionalLight);
RPR_DECL(frDirectionalLightSetRadiantPower3f);
RPR_DECL(frDirectionalLightSetShadowSoftness);
RPR_DECL(frContextCreateEnvironmentLight);
RPR_DECL(frEnvironmentLightSetImage);
RPR_DECL(frEnvironmentLightSetIntensityScale);
RPR_DECL(frEnvironmentLightAttachPortal);
RPR_DECL(frEnvironmentLightDetachPortal);
RPR_DECL(frContextCreateSkyLight);
RPR_DECL(frSkyLightSetTurbidity);
RPR_DECL(frSkyLightSetAlbedo);
RPR_DECL(frSkyLightSetScale);
RPR_DECL(frSkyLightSetDirection);
RPR_DECL(frSkyLightAttachPortal);
RPR_DECL(frSkyLightDetachPortal);
RPR_DECL(frContextCreateIESLight);
RPR_DECL(frIESLightSetRadiantPower3f);
RPR_DECL(frIESLightSetImageFromFile);
RPR_DECL(frIESLightSetImageFromIESdata);
RPR_DECL(frLightGetInfo);
RPR_DECL(frSceneClear);
RPR_DECL(frSceneAttachShape);
RPR_DECL(frSceneDetachShape);
RPR_DECL(frSceneAttachHeteroVolume);
RPR_DECL(frSceneDetachHeteroVolume);
RPR_DECL(frSceneAttachCurve);
RPR_DECL(frSceneDetachCurve);
RPR_DECL(frCurveSetMaterial);
RPR_DECL(frCurveSetTransform);
RPR_DECL(frContextCreateCurve);
RPR_DECL(frSceneAttachLight);
RPR_DECL(frSceneDetachLight);
RPR_DECL(frSceneGetInfo);
RPR_DECL(frSceneGetEnvironmentOverride);
RPR_DECL(frSceneSetEnvironmentOverride);
RPR_DECL(frSceneSetBackgroundImage);
RPR_DECL(frSceneGetBackgroundImage);
RPR_DECL(frSceneSetCamera);
RPR_DECL(frSceneGetCamera);
RPR_DECL(frFrameBufferGetInfo);
RPR_DECL(frFrameBufferClear);
RPR_DECL(frFrameBufferSaveToFile);
RPR_DECL(frContextResolveFrameBuffer);
RPR_DECL(frContextCreateMaterialSystem);
RPR_DECL(frMaterialSystemGetSize);
RPR_DECL(frMaterialSystemCreateNode);
RPR_DECL(frMaterialNodeSetInputN);
RPR_DECL(frMaterialNodeSetInputF);
RPR_DECL(frMaterialNodeSetInputU);
RPR_DECL(frMaterialNodeSetInputImageData);
RPR_DECL(frMaterialNodeSetInputBufferData);
RPR_DECL(frMaterialNodeGetInfo);
RPR_DECL(frMaterialNodeGetInputInfo);
RPR_DECL(frContextCreateComposite);
RPR_DECL(frContextCreateLUTFromFile);
RPR_DECL(frContextCreateLUTFromData);
RPR_DECL(frCompositeSetInputFb);
RPR_DECL(frCompositeSetInputC);
RPR_DECL(frCompositeSetInputLUT);
RPR_DECL(frCompositeSetInput4f);
RPR_DECL(frCompositeSetInput1u);
RPR_DECL(frCompositeSetInputOp);
RPR_DECL(frCompositeCompute);
RPR_DECL(frCompositeGetInfo);
RPR_DECL(frObjectDelete);
RPR_DECL(frObjectSetName);
RPR_DECL(frContextCreatePostEffect);
RPR_DECL(frContextAttachPostEffect);
RPR_DECL(frContextDetachPostEffect);
RPR_DECL(frPostEffectSetParameter1u);
RPR_DECL(frPostEffectSetParameter1f);
RPR_DECL(frPostEffectSetParameter3f);
RPR_DECL(frPostEffectSetParameter4f);
RPR_DECL(frContextGetAttachedPostEffectCount);
RPR_DECL(frContextGetAttachedPostEffect);
RPR_DECL(frPostEffectGetInfo);
RPR_DECL(frContextCreateGrid);
RPR_DECL(frContextCreateHeteroVolume);
RPR_DECL(frShapeSetHeteroVolume);
RPR_DECL(frHeteroVolumeSetTransform);
RPR_DECL(frHeteroVolumeSetEmissionGrid);
RPR_DECL(frHeteroVolumeSetDensityGrid);
RPR_DECL(frHeteroVolumeSetAlbedoGrid);
RPR_DECL(frHeteroVolumeSetEmissionLookup);
RPR_DECL(frHeteroVolumeSetDensityLookup);
RPR_DECL(frHeteroVolumeSetAlbedoLookup);
RPR_DECL(frHeteroVolumeSetAlbedoScale);
RPR_DECL(frHeteroVolumeSetEmissionScale);
RPR_DECL(frHeteroVolumeSetDensityScale);
