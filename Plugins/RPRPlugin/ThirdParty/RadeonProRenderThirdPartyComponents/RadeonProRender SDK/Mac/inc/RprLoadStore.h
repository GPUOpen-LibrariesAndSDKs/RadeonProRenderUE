...
extern RPR_API_ENTRY int rprsListImportedGrids(void * * Grids, int sizeGridsBytes, int * numberOfGrids);
...
// 
extern RPR_API_ENTRY int rprsAssignShapeToGroup(rpr_shape shape, const rpr_char * groupName);
extern RPR_API_ENTRY int rprsAssignCameraToGroup(rpr_camera camera, const rpr_char * groupName);
extern RPR_API_ENTRY int rprsAssignParentGroupToGroup(const rpr_char * groupChild, const rpr_char * groupParent);
extern RPR_API_ENTRY int rprsSetTransformGroup(const rpr_char * groupChild, const float * matrixComponents);
extern RPR_API_ENTRY int rprsGetParentGroupFromShape(rpr_shape shape, size_t size, rpr_char * groupName, size_t * size_ret);
extern RPR_API_ENTRY int rprsGetParentGroupFromCamera(rpr_camera camera, size_t size, rpr_char * groupName, size_t * size_ret);
extern RPR_API_ENTRY int rprsGetParentGroupFromGroup(const rpr_char * groupChild, size_t size, rpr_char * groupName, size_t * size_ret);
...
extern RPR_API_ENTRY int rprsReleaseImportedData();
...
extern RPR_API_ENTRY int rprsDeleteListImportedObjects(void * contextX);
...
extern RPR_API_ENTRY int rprsAddAnimation(const rprs_animation * anim);
