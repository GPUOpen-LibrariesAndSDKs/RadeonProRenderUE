...
CALL %1\Engine\Build\BatchFiles\RunUAT.bat BuildPlugin -Plugin="%CD%\..\..\Plugins\RPRPlugin\RPRPlugin.uplugin" -nop4 -utf8output -pak  -package="%OutputPath%" -Rocket -TargetPlatforms=Win64 %UATArgs%
